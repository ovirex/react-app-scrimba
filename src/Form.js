...
class Form extends Component {
    ...
    render() {
        const dieteryRest = [];
        for (let prop in this.state.dietery) { 
                if (this.state.dietery[prop] === true) {
                    dieteryRest.push(prop)                    
                }
        }
        const trueDieteryRest = dieteryRest.join(", ")
        return (
            <main >
                <form>
                    <label>
                ...
                <p><b>Your dietary restrictions:</b></p>
                    {/*<p>Vegan {this.state.dietery.vegan ? "Yes" : "No"}</p>
                    <p>Vegan {this.state.dietery.vegeterian ? "Yes" : "No"}</p>
                    <p>Vegan {this.state.dietery.lactoseFree ? "Yes" : "No"}</p>*/}
                    <p>{trueDieteryRest}</p>
            </main>
        )
    }
